...
function onCreate()
	...
	makeLuaSprite('Background', 'veefunkin/Ocean/Background', -1100, -400);
        addLuaSprite('Background', false)

	makeLuaSprite('Rock-back', 'veefunkin/Ocean/Rock-back', 400, -400);
        addLuaSprite('Rock-back', false)

	makeLuaSprite('Rock-front', 'veefunkin/Ocean/Rock-front', -900, -400);
        addLuaSprite('Rock-front', false)
	
        makeLuaSprite('Rock-far-far', 'veefunkin/Ocean/Rock-far-far', 1300, 550);
        addLuaSprite('Rock-far-far', false)

        makeAnimatedLuaSprite('Feesh', 'veefunkin/Feesh', -200, 0)
	addAnimationByPrefix('Feesh','Feesh','Feesh', 24, true)
        addLuaSprite('Feesh',false);
	objectPlayAnimation('Feesh', 'Feesh', true);

        makeLuaSprite('Black', 'veefunkin/Black', -1000, -500);
