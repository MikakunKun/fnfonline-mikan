function onCreate()
	...
	makeLuaSprite('Volcan-BG', 'veefunkin/Volcan-BG', -1500, -500);
        addLuaSprite('Volcan-BG', false)

	makeLuaSprite('Volcan-Cano', 'veefunkin/Volcan-Cano', -1000, -1000);
        addLuaSprite('Volcan-Cano', false)

	makeLuaSprite('Volcan-Ground', 'veefunkin/Volcan-Ground', -1500, 1000);
        addLuaSprite('Volcan-Ground', false)

	makeLuaSprite('Volcan-Smoke', veefunkin/'Volcan-Smoke', -1500, 530);
        addLuaSprite('Volcan-Smoke', true)

        makeAnimatedLuaSprite('Volcan-Lava', 'veefunkin/Volcan-Lava', -1000, -270)
