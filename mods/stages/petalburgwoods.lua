...
function onCreate()
	...
	makeLuaSprite('far back', 'swampert/far back', -950, -600);
	addLuaSprite('far back', false);
	setLuaSpriteScrollFactor('far back', 0.6, 0.6);

	makeLuaSprite('back plants', 'swampert/back plants', -950, -550);
	addLuaSprite('back plants', false);
	setLuaSpriteScrollFactor('back plants', 0.8, 0.8);

	makeLuaSprite('ground', 'swampert/ground', -880, 220);
	addLuaSprite('ground', false);
	setLuaSpriteScrollFactor('ground', 1.0, 1.0);

	makeLuaSprite('front plants', 'swampert/front plants', -870, 480);
