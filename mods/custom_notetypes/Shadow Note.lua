function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Shadow Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'funkmon/Shadow_Note_assets'); --Change texture
			setPropertyFromGroup('unspawnNotes', i, 'noteSplashTexture', 'funkmon/Shadow_Splash_assets');
