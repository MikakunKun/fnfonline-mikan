function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Confusion Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'funkmon/Confusion_Note_assets'); --Change texture
			setPropertyFromGroup('unspawnNotes', i, 'noteSplashTexture', 'funkmon/Confusion_Splash_assets');
